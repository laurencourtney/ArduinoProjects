...
unsigned long timeold;
 ...
 void rpm_fun()
 {
   //Each rotation, this interrupt function is run three times, so take that into consideration for 
   //calculating RPM
   //Update count
      rpmcount++;
...
void setup()
 ...
 void loop()
 {
   ...
   //for multi-bladed propellers or fans - my fan has three blades. 
